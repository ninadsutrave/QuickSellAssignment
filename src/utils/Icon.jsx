...
export const getStatusIcon = (status) => {
    switch (status) {
        ...
        case "Canceled":
          return <Canceled size={20} color={"gray"} />;
        default:
          return <Canceled size={20} color={"gray"} />;
    }
}
...
export const getPriorityIcon = (priority) => {
    switch (priority) {
        ...
        case 1:
          return <img src={LowPriority} width={18} height={18} />;
        case 2:
            return <img src={MediumPriority} width={18} height={18} />;
        case 3:
            return <img src={HighPriority} width={18} height={18} />;
        case 4:
...
export const getUserIcon = (user) => {
  return <img className="user-icon" src={`https://ui-avatars.com/api/?name=${user}&background=random`} width="20px" height="20px" />
}